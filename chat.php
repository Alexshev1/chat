...
.session-text{width:200px; height:30px;padding:6px 10px;margin: 8px 0;border: 1px solid #e6e6e6;border-radius: 4px;box-sizing: border-box; font-size:24px}
...
<body>
<div id="logout">
	<a href="index.php" style="color:black; text-decoration: none"><i class="fa fa-sign-out" aria-hidden="true"></i>Выход</a>
</div>

<div id="container">

<div id="session-name">
	Ваше имя: <input type="text" value="<?= $_SESSION['uname'] ?>" class="session-text" disabled>
</div>
...
<div id="form-container">
	<div class="form-text">
    	...
    	<textarea id="comment" placeholder="Введите сообщение..."></textarea>
        <style>
            #comment {
                outline: none;
            }
    ...
    <div class="form-btn">
    	<input type="submit" value="Отправить" id="btn" name="btn"/>
    </div>
</div>
</form>
